                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-lg-10 mx-auto">
                            <div className="row">
                                ...
                                <div className="col-6 col-lg-3">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-3 mx-auto">
                                            <a href="https://twitter.com/"><i className="fab fa-twitter fontawesome-style"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <hr />
                            <div className="mt-5">
                                <p className="main-hero-para text-center w-100">Copyright @ 2021 EYPay. All rights reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
