...
const Contact = () => {
    ...
    const submitData = async (e) => {
        ...
        if (firstName && lastName && phone && email && address && message) {
            e.preventDefault();
            const res = await fetch('https://eypay-7e597-default-rtdb.firebaseio.com/userDataRecords.json', {
                method: "POST",
                headers: {
                            ...
                            <div className="row">
                                ...
                                <div className="contact-rightside col-12 col-lg-7">
                                    <form method="POST">
                                        ...
                                        <button type="button" className="btn btn-style w-100" onClick={submitData}>Submit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
